...
void initialise_premiers(void){
  ...
  //LI
  premiers[_listeInstruction_][ID_VAR] = 1;
  premiers[_listeInstruction_][ACCOLADE_OUVRANTE] = 1;
  premiers[_listeInstruction_][SI] = 1;
  premiers[_listeInstruction_][TANTQUE] = 1;
  premiers[_listeInstruction_][ID_FCT] = 1;
  premiers[_listeInstruction_][RETOUR] = 1;
  premiers[_listeInstruction_][ECRIRE] = 1;
  premiers[_listeInstruction_][POINT_VIRGULE] = 1;
  premiers[_listeInstruction_][EPSILON] = 1;
  ...
  //EXPB
  premiers[_expressionBis_][OU] = 1;  //pas sur pour le OU "|"
  ...
  //CONJB
  premiers[_conjonctionBis_][ET] = 1;   //pas sur pour le ET "&"
